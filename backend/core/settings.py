...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-default-dev-key-change-me-in-production')
...
# Uses PostgreSQL if DB_ENGINE or DB_HOST is set; falls back to SQLite for local standalone development
